...
onMounted(() => {
  ...
  const resize = function () {
    canvas.height = domeRef.value.getBoundingClientRect().height
    canvas.width = domeRef.value.getBoundingClientRect().width
  }

  canvas.onclick = addRocket
  domeRef.value.appendChild(canvas)
